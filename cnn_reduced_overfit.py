...
transfer_model = tf.keras.Sequential([
    ...
    tf.keras.layers.Conv2D(32, (5,5), activation='relu', padding="same", kernel_regularizer=l2(0.07)),
    tf.keras.layers.Conv2D(64, (5,5), activation='relu', padding="same", kernel_regularizer=l2(0.07)),
    tf.keras.layers.BatchNormalization(),
    tf.keras.layers.GlobalAveragePooling2D(),
    tf.keras.layers.Dense(128, activation='relu', kernel_regularizer=l2(0.07)),
